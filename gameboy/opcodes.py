...
# OPCODE  LABEL          LENGTH  ARG TYPE CYCLS  FLAGS
    0x00: ("RLC B",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x01: ("RLC C",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x02: ("RLC D",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x03: ("RLC E",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x04: ("RLC H",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x05: ("RLC L",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x06: ("RLC (HL)",        1, TYPE_VOID,  16, ("Z", 0, 0, "C")),
    0x07: ("RLC A",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x08: ("RRC B",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x09: ("RRC C",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x0a: ("RRC D",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x0b: ("RRC E",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x0c: ("RRC H",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x0d: ("RRC L",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    0x0e: ("RRC (HL)",        1, TYPE_VOID,  16, ("Z", 0, 0, "C")),
    0x0f: ("RRC A",           1, TYPE_VOID,   8, ("Z", 0, 0, "C")),
    ...
    0x7c: ("BIT 7, H",        1, TYPE_VOID,   8, ("Z", 0, 1, None)),
